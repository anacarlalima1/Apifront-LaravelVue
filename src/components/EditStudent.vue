...
<div id="app">
  ...
  <div class="container"> 
          ...
          <input class="input-group input-group-sm mb-3" style="margin-bottom: 30px;" type="text" placeholder="Nome" v-model="s.name">
           <label>Serie:</label>
          <input class="input-group input-group-sm mb-3" style="margin-bottom: 30px;" type="text" placeholder="Nome" v-model="s.serie">
           <label>Escola:</label>
          <input class="input-group input-group-sm mb-3" style="margin-bottom: 30px;" type="text" placeholder="Nome" v-model="s.school">
